...
const Donate = () => {
    ...
    const initialProducts = [
        ...
        { id: 4, name: 'Help poor kids', image: legpatient, by: "Kee Operation", description: "Support underprivileged children with education and healthcare.",raised:"13060" },
        { id: 5, name: 'Save the forest people', image: healthissues, by: "Mouth Cancer", description: "Contribute to the conservation of indigenous communities with mouth cancer.",raised:"1400" },
        ...
        { id: 8, name: 'Give life to cancer patients', image: braintumor, by: "Cancer Child", description: "Provide life-saving treatment and care to cancer patients.",raised:"9000" },
        { id: 9, name: 'Help the people', image: floods2, by: "Floods Attacked people", description: "Assist communities affected by natural disasters like floods.",raised:"3000" },
